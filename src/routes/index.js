...
router.post("/patients/:_id",PatientController.deletePatient)//Elimina un paciente desde su pagina, los formularios en html, solo tienen dos métodos:get y post por eso no se utilza router.delete
//No Funciona
